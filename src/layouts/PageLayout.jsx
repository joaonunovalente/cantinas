    ...
    <>
      <div className="site-shell">
        <div className="page-header-wrapper">
          ...
          <div className="text-center px-3 py-2 small fw-semibold" style={{ background: '#054d2c', color: '#fff' }}>
            As ementas estão também disponíveis na rede social {' '}
            <a className="fw-bold" href="https://bsky.app/profile/cantinas.pt" style={{ color: '#7dcea1' }}>BlueSky</a>.
          </div>
